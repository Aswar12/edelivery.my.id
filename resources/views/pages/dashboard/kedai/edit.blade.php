<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Kedai &raquo; {{ $item->name }} &raquo; Edit
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('dashboard.kedai.update', $item->id) }}" method="post"
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <select name="categories_id"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name">
                                <option value="{{ $item->user_id }}">{{ \App\Models\User::find($item->user_id)->name }}
                                </option>
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('phone_number') ?? $item->phone_number }}" name="phone_number"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
